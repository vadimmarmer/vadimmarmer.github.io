...
- **Null hypothesis**, denoted as **$H_{0}$**: A hypothesis that is held to be true, unless the data provides a **sufficient** evidence against it.
...
- Unfortunately, the probabilities of Type I and II errors are inversely related. By decreasing the probability of Type I error $\alpha ,$ one makes the critical region smaller, which increases the probability of the Type II error. Thus it is impossible to make both errors arbitrary small.
