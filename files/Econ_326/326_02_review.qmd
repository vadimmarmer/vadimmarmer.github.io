...
- Claim: $|E(XY)| \leq \sqrt{EX^2 EY^2}$.

- **Proof**: Consider the following two random variables: $\frac{X}{\sqrt{EX^2}} + \frac{Y}{\sqrt{EY^2}}$ and $\frac{X}{\sqrt{EX^2}} - \frac{Y}{\sqrt{EY^2}}$.
  $$
  E\left(\frac{X}{\sqrt{EX^2}} + \frac{Y}{\sqrt{EY^2}}\right)^2 = 1 + 1 + 2\frac{E(XY)}{\sqrt{EX^2 EY^2}} \geq 0,
  $$
  or $-\sqrt{EX^2 EY^2} \leq E(XY)$.

## Appendix: The Cauchy-Schwartz Inequality (continued)

Similarly,
$$
E\left(\frac{X}{\sqrt{EX^2}} - \frac{Y}{\sqrt{EY^2}}\right)^2 = 2 - 2\frac{E(XY)}{\sqrt{EX^2 EY^2}} \geq 0,
$$
or
$$
...
Together:
$$
-\sqrt{EX^2 EY^2} \leq E(XY) \leq \sqrt{EX^2 EY^2},
$$
or
$$
|E(XY)| \leq \sqrt{EX^2 EY^2}.
...
Let $U = X - EX$ and $V = Y - EY$. Then,
$$
|E(UV)| \leq \sqrt{EU^2 EV^2},
$$
or
$$
