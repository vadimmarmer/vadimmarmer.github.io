...
- Variance:
  ...
  $$
  $$
  Var(X) = E(X^2) - (EX)^2 = \frac{1}{3} - \left(\frac{1}{2}\right)^2 = \frac{1}{3} - \frac{1}{4} = \frac{1}{12}.
  $$
...
- Since variances are always non-negative:
  ...
  [$\quad= Var(Y) + Var(\beta X) - 2Cov(Y, \beta X) \quad (\text{prop. of var.})$]{.fragment}
