...
- Since variances are always non-negative:
  ...
  [$\quad= \Var{Y} + \underbrace{\left(\frac{\Cov{X, Y}}{\Var{X}}\right)^2}_{=\beta^2} \Var{X} - 2 \underbrace{\left(\frac{\Cov{X, Y}}{\Var{X}} \right)}_{=\beta}\Cov{X, Y} \quad (\text{def. of } \beta)$]{.fragment}
