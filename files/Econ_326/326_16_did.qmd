...
- The pre-treatment coefficients $\mu_k$ for $k < 0$ serve as a diagnostic:
  ...
  |---|---|
  | $\mu_{-3} \approx \mu_{-2} \approx \mu_{-1} \approx 0$ | Both assumptions look plausible |
  | $\mu_{-3} \approx \mu_{-2} \approx 0$ but $\mu_{-1} \neq 0$ | **Anticipation**: units react to news of upcoming treatment one period before it starts |
  | $\mu_{-3}, \mu_{-2}, \mu_{-1}$ trending (e.g., growing in magnitude) | **Parallel trends violation**: groups were already diverging before treatment |
