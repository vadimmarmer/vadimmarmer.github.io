...
- Substituting observed outcomes with potential outcomes:
  ...
  \begin{align*}
  \beta &= \E{Y_{i1}(1) {\color{red}- Y_{i0}(1)} \mid D_i = 1} \\
...
- To relate $\beta$ to the ATT, add and subtract $\E{Y_{i1}(0) \mid D_i = 1}$ and $\E{Y_{i0}(0) \mid D_i = 1}$ inside the first expectation:
  ...
  \begin{align*}
  \beta &= \E{Y_{i1}(1) {\color{red}- Y_{i0}(1)} \mid D_i = 1} {\color{blue}- \E{Y_{i1}(0) - Y_{i0}(0) \mid D_i = 0}} \\
  &= \E{Y_{i1}(1) \underbrace{- Y_{i1}(0) {\color{blue}+ Y_{i1}(0)}}_{= \, 0} \underbrace{{\color{blue}- Y_{i0}(0)} {\color{red}+ Y_{i0}(0)}}_{= \, 0} {\color{red}- Y_{i0}(1)} \mid D_i = 1} \\
  &\quad {\color{blue}- \E{Y_{i1}(0) - Y_{i0}(0) \mid D_i = 0}}.
  \end{align*}
