...
- ${\color{teal}\beta_{-2}}$ is the difference in backward trends from $t = -2$ to $t = -1$ between treatment and control: $({\color{blue}\delta_{-2}} + {\color{teal}\beta_{-2}}) - {\color{blue}\delta_{-2}} = {\color{teal}\beta_{-2}}$.

- More generally, ${\color{teal}\beta_s}$ for $s \leq -2$ is the difference in backward trends from $t = s$ to $t = -1$ between treatment and control.
...
- This is the standard **event study** specification used in the literature for DID with multiple periods.
