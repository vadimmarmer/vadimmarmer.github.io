...
- However, covariates explain variation in earnings, reducing residual variance. The standard error of $\hat{\tau}$ shrinks, so estimates become more precise.

- This contrasts with **observational data**: without randomization, omitting relevant covariates causes the coefficient on $D_i$ to absorb selection bias, and the ATE estimate changes substantially when controls are added.
