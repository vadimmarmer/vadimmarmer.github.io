...
```{=html}
<span style="display:none">\(\newcommand{\fragment}[2]{\class{fragment}{#2}}\)</span>
```
...
- Next, let $\sigma_{\hat{\beta}_{1}} = \sqrt{\Var{\hat{\beta}_{1} \mid \mathbf{X}}}$. Then:
  ...
  &\fragment{1}{{}\Longleftrightarrow -z_{1-\alpha /2}\,\sigma_{\hat{\beta}_{1}} \leq \beta _{1}-\hat{\beta}_{1}\leq z_{1-\alpha /2}\,\sigma_{\hat{\beta}_{1}}} \\
  &\fragment{2}{{}\Longleftrightarrow -z_{1-\alpha /2}\,\sigma_{\hat{\beta}_{1}} \leq \hat{\beta}_{1}-\beta _{1}\leq z_{1-\alpha /2}\,\sigma_{\hat{\beta}_{1}}} \\
  &\fragment{3}{{}\Longleftrightarrow -z_{1-\alpha /2}\leq \frac{\hat{\beta}_{1}-\beta _{1}}{\sigma_{\hat{\beta}_{1}}}\leq z_{1-\alpha /2}}
  \end{aligned}
  $$
:::

::: {.fragment}
- We have that $\beta _{1}\in CI_{1-\alpha}$
  $$
...
::: {.fragment}
- Let $Z=\dfrac{\hat{\beta}_{1}-\beta _{1}}{\sigma_{\hat{\beta}_{1}}}\sim N\left( 0,1\right)$ conditionally on $\mathbf{X}$.
  $$
  \begin{aligned}
  &P\left( -z_{1-\alpha /2}\leq Z \leq z_{1-\alpha /2} \mid \mathbf{X}\right) \\
  &\fragment{1}{{}=P\left( z_{\alpha /2}\leq Z\leq z_{1-\alpha /2} \mid \mathbf{X}\right)} \\
  &\fragment{2}{{}=1-\alpha /2-\alpha /2=1-\alpha .}
  \end{aligned}
  $$
:::
