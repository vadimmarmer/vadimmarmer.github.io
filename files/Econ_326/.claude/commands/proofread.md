---
description: Proofread an Econ 326 (Introduction to Econometrics II) QMD lecture file (spelling, grammar, course title, notation, math, conditioning, layout, slide titles, reveal order, compilation)
