...
| `527_02_ols_properties.qmd` | Deck 2, 818 lines | Published, trimmed 2026-09-17 |
...
| `output/527_02_ols_properties.pdf` | The PDF | Live |
...
Sixty-four corrections were applied in the first proofreading round and a second round followed, both on 2026-09-07 before the move.
...
1. Deck 2 exists in two places: here, and the working copy in `/Users/vmarmer/Documents/teaching/Econ_527/slides/`. They have diverged since the 2026-09-17 trim, made here only. Decide which one is edited from now on, so the two do not drift further.
